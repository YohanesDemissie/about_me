    ...
    return (
      <div className="about-me">
        <body>
          ...
          <p className="container"><div className="p-hide">JavaScript developer that has built full-stack web applications with server-side Node.js and modern, client-side, front-end libraries and frameworks, including React, implementing best industry practices.
          ...
          <b><div className="p-show">Yohanes Demissie: </div></b>
          </p>
        </body>
        <footer>
          Technical Tools
